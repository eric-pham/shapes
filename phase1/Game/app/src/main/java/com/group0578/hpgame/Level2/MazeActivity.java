...
public class MazeActivity extends AppCompatActivity {
    ...
    public class MazeView extends SurfaceView implements Runnable, Maze.View, View.OnTouchListener{
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            return false; // returns true so the user can continue dragging/clicking to move the player
        }
    ...
    /**
     * When the button on the activity_go_to_level_3.xml is clicked, the level 3 activity is started.
     * @param view the view
     */
