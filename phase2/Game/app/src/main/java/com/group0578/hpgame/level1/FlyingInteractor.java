...
class FlyingInteractor {
  ...
  /**
   * Create a new FlyingInteractor with the given SQLiteHelper and username. This class stores and
   * returns the user's information from the database required to run the level.
   *
