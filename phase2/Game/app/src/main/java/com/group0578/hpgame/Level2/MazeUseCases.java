...
public class MazeUseCases {
    ...
    /**
     * Initializes a 2D array to hold the required number of MazeSection objects that will be used
     * to build the maze.
     ...
     */
    private void modifyWalls(MazeSection currSection, MazeSection nextSection, RelativeLocation relativeLocation) {
    ...
    /**
     * Determines the locational relationship between the current MazeSection and the next MazeSection.
     * @param currSection The current MazeSection.
     * @param nextSection The next MazeSection.
