...
/**
 * Methods from this class were derived from Part 2 of Y-Key's "Android Programming - Maze Game" 5
 * part Tutorial and modified to suit the needs of our project
 *
 * <p>Sources: Part 2: https://www.youtube.com/watch?v=iri0wZ3NvdQ
 *
 * <p>The class responsible for drawing the maze on the maze canvas during level 2.
 */
class MazePainter {
  ...
  void drawMaze(Canvas mazeCanvas, Timer timer) {
    ...
    mazeCanvas.drawText(
        "Player = Smaller", 100, maze.getScreenHeight() - 100, this.maze.getTextBrush());
    mazeCanvas.drawText(
        "End Point = Square", 550, maze.getScreenHeight() - 100, this.maze.getTextBrush());
    mazeCanvas.drawText(timer.getSecondsPassedString(), 100, 100, this.maze.getTextBrush());
    mazeCanvas.drawText(
        "Lives: " + this.maze.getPlayer().getLives(), 100, 150, this.maze.getTextBrush());
