...
public class SQLiteManager {
  ...
  /**
   * double that represents the time in seconds and milliseconds that it took to complete level one
   */
  private double levelOneTime;

  /**
   * double that represents the time in seconds and milliseconds that it took to complete level two
   */
