...
//    mazeView = new MazeView(this, this);
//
...
//    mazeThread =
//        new MazeThread(
//            mazeView.getSurfaceHolder(),
//            mazeView,
//            this,
//            mazePresenter); // might not need second param
//
//
//  }
//
...
//   *
//   * <p>Begins running a new thread and sets mazeThread to a new Thread object.
//   */
//  @Override
//  protected void onResume() {
//    super.onResume();
//    mazeThread = new MazeThread(mazeView.getSurfaceHolder(),
//            mazeView,
//            this,
//            mazePresenter);
//    mazeThread.setRunning(true);
...
//  }
  ...
  //
  //        /**
  //         * The array representing the maze; structured as a grid where each element is a
  // MazeSection.
  //         */
  ...
  //
  //        /**
  //         * The final location in the mazeGrid array the user reaches upon completion of the
  // Maze.
  //         */
  ...
  //
  //                // After drawing and performing actions on mazeCanvas, show mazeCanvas on the
  // screen
  ...
  //
  //        /**
  //         * Initializes the exitPoint attribute to last column and last row in the mazeGrid
  // array.
  //         */
  ...
  //
  //        /**
  //         * Initializes and performs actions on mazeBrush attribute which is used to draw the
  // maze.
  //         */
  ...
  //
  //        /**
  //         * Drawing a circle on the screen representing the player's current location in the
  // maze.
  ...
  //
  //        /**
  //         * Called when a touch event is dispatched to a view. This allows users to click/drag
  // the
  ...
  //                float currPlayerX = horizontalMargin + (player.getCol()+0.5f) *
  // mazeSectionLength;
  ...
  //                float displacementX = touchX - currPlayerX, displacementY = touchY -
  // currPlayerY;
  //
  ...
  //                if (absDisplacementX > mazeSectionLength || absDisplacementY >
  // mazeSectionLength) {
  //
  ...
  //            }
  //
  //            return false; // returns true so the user can continue dragging/clicking to move the
  // player
  //        }
  //
  //        /**
  //         * Checks whether the player has reached the exit square
  //         */
  //        private void atFinish() {
  //            if (player.getCol() == 3 && player.getRow() == 3) {
  //                MazeActivity.this.goToNextLevel();
  //            }
  //        }
  //
  //        /**
  ...
  //
  //    /**
  //     * Stops the mazeThread and changes the content view
  //     */
  //    private void goToNextLevel() {
  //        mazeView.pause();
  //        setContentView(R.layout.activity_go_to_level_3);
  //    }
  //
  //    /**
  //     * When the button on the activity_go_to_level_3.xml is clicked, the level 3 activity is
  // started.
  //     * @param view the view
  //     */
  //    public void onClickGoToLevel3(View view) {
  //        Intent goToLevel3 = new Intent(this, Level3MainActivity.class);
